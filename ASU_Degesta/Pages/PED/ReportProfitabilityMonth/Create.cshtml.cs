...
namespace ASU_Degesta.Pages.PED.ReportProfitabilityMonth
{
    ...
    public class CreateModel : PageModel
    {
        ...
        [BindProperty] public string rep_cost_id { get; set; } = default!;
        [BindProperty] public string rep_plan_id { get; set; } = default!;
        [BindProperty] public string price_list_id { get; set; } = default!;
        ...
        public async Task<IActionResult> OnPostAsync()
        {
                ...
                (t_p, pl_mth) => new {t_p, pl_mth}).Select(x => new
            {
                ...
                profit = Math.Round(x.t_p.mc.produced * x.pl_mth.price - x.t_p.mc.produced * x.t_p.t_p.cost.cost_price,2),
                ...
                sum = Math.Round((x.t_p.mc.produced * x.pl_mth.price - x.t_p.mc.produced * x.t_p.t_p.cost.cost_price) / (x.t_p.mc.produced * x.pl_mth.price) , 2),
