...
[ApiController]
[Route("api/GetMonthlyProductReleasePlanDocx")]
public class MonthlyProductReleasePlanController : Controller
{
    public ActionResult OnGet([FromBody] MonthlyProductReleasePlanData data)
    {
                   ...
                   DocumentFormat.OpenXml.WordprocessingDocumentType.Document, true))
        {
            ...
            foreach (var item in datas)
            {
                data_table.Add(new List<string>()
                {
                    ...
                    item.count.ToString(), data.UnitsList.Where(x=>x.Units_ID == item.units_id).FirstOrDefault().Name
                });
            }
    ...
    public class MonthlyProductReleasePlanData
    {
        public List<MonthlyProductReleasePlan> Reports { get; set; }
        public MonthlyProductReleasePlan_id Report_ID { get; set; }
