...
[ApiController]
[Route("api/GetForecastMaximumDemandProductsDocx")]
public class ForecastMaximumDemandProductsController : Controller
{
    public ActionResult OnGet([FromBody] ForecastMaximumDemandProductsData data)
    {
                   ...
                   DocumentFormat.OpenXml.WordprocessingDocumentType.Document, true))
        {
            ...
            foreach (var item in datas)
            {
                data_table.Add(new List<string>()
                {
                    ...
                    item.demand.ToString(), data.UnitsList.Where(x=>x.Units_ID == item.units_id).FirstOrDefault().Name
                });
            }
    ...
    public class ForecastMaximumDemandProductsData
    {
        public List<ForecastMaximumDemandProducts> Reports { get; set; }
        public ForecastMaximumDemandProducts_id Report_ID { get; set; }
