...
[ApiController]
[Route("api/GetReportCostsProductionCapacityDocx")]
public class ReportCostsProductionCapacityController : Controller
{
    public ActionResult OnGet([FromBody] ReportCostsProductionCapacityData data)
    {
                   ...
                   DocumentFormat.OpenXml.WordprocessingDocumentType.Document, true))
        {
            ...
            foreach (var item in datas)
            {
                data_table.Add(new List<string>()
                {
                    ...
                    data.TypesOfProductsList.Where(x=>x.TypesOfProductsId == item.types_of_products_id).FirstOrDefault().Name, item.costs.ToString()
                });
            }
    ...
    public class ReportCostsProductionCapacityData
    {
        public List<ReportCostsProductionCapacity> Reports { get; set; }
        public ReportCostsProductionCapacity_id Report_ID { get; set; }
